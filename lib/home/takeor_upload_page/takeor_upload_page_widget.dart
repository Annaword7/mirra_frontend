                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [Color(0xFFBEC9EF), Color(0xFFFBF6FF)],
                            stops: [0.0, 1.0],
                                    ...
                                    children: [
                                      if (!FFAppState().isprouser)
                                        LinearPercentIndicator(
                                          ...
                                          progressColor: Color(0x935C85D9),
                                          backgroundColor:
                                              FlutterFlowTheme.of(context)
                                                  .alternate,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'qb4ojhyz' /*  analyses remaining this month */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'e431pan7' /*  analyses remaining this month */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                      ...
                      if (!FFAppState().analysisloading)
                        Text(
                          FFLocalizations.of(context).getText(
                            'h67zdlkd' /* Choose how you'd like to uploa... */,
                          ),
