                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'i7sno6fc' /* Enter your details to continue */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  key: ValueKey('emailAddress_jmyt'),
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              '9jzxfvzw' /* By continuing, you agree to ou... */,
                                            ),
                                            style: TextStyle(),
                                          )
                                        ],
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'oksxunlm' /* Terms and Privacy Policy */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodySmall
                                                .override(
