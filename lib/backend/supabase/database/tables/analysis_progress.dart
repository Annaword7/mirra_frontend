...
class AnalysisProgressTable extends SupabaseTable<AnalysisProgressRow> {
  @override
  String get tableName => 'analysis_progress';

  @override
  AnalysisProgressRow createRow(Map<String, dynamic> data) =>
      AnalysisProgressRow(data);
}

class AnalysisProgressRow extends SupabaseDataRow {
  AnalysisProgressRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AnalysisProgressTable();
